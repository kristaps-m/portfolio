...
export default function GitHubAcitvity() {
  // 1 year range
  ...
  //console.log("Hi all this is data \n",data);
  return (
    <>
      ...
      <Timeline range={dateRange} data={data} colorFunc={({ alpha }) => `rgba(100, 5,  200, ${alpha})`} /> */}
    </>
  )
}


//ReactDOM.render(<GitHubAcitvity />, document.getElementById('container'));